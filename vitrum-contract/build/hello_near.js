...
var _dec, _class, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class2, _class3;
let Candidate = (_dec = NearBindgen({}), _dec(_class = class Candidate {
  constructor(name) {
    this.name = name;
    this.votes = 0;
  }
...
let VotingContract = (_dec2 = NearBindgen({}), _dec3 = view(), _dec4 = view(), _dec5 = call({}), _dec6 = call({}), _dec7 = call({}), _dec2(_class2 = (_class3 = class VotingContract {
  candidates = new UnorderedMap("candidates");
  tempIds = new LookupMap("tempIds");
  getCandidates() {
  ...
  vote({
    ...
    assert(voter === signerAccountId(), "Unauthorized vote attempt");
...
}, (_applyDecoratedDescriptor(_class3.prototype, "getCandidates", [_dec3], Object.getOwnPropertyDescriptor(_class3.prototype, "getCandidates"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "getVotes", [_dec4], Object.getOwnPropertyDescriptor(_class3.prototype, "getVotes"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "addCandidate", [_dec5], Object.getOwnPropertyDescriptor(_class3.prototype, "addCandidate"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "requestVoteId", [_dec6], Object.getOwnPropertyDescriptor(_class3.prototype, "requestVoteId"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "vote", [_dec7], Object.getOwnPropertyDescriptor(_class3.prototype, "vote"), _class3.prototype)), _class3)) || _class2);
function vote() {
...
function requestVoteId() {
  ...
  const _args = VotingContract._getArgs();
  const _result = _contract.requestVoteId(_args);
  VotingContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(VotingContract._serialize(_result, true));
}
...
export { addCandidate, getCandidates, getVotes, requestVoteId, vote };
